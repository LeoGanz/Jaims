...
public enum EFileType {
	FILETYPE_AUDIO(Values.FILETYPE_AUDIO), FILETYPE_PDF(Values.FILETYPE_PDF), FILETYPE_VIDEO(
			Values.FILETYPE_VIDEO), FILETYPE_TEXT(Values.FILETYPE_TEXT), FILETYPE_WORD(
					Values.FILETYPE_WORD), FILETYPE_EXCEL(Values.FILETYPE_EXCEL), FILETYPE_OPD(
							Values.FILETYPE_ODP), FILETYPE_ZIP(Values.FILETYPE_ZIP), FILETYPE_PPT(Values.FILETYPE_PPT);
	...
	public static class Values {
		...
		public static final String	FILETYPE_ODP	= "FILETYPE_ODP";
