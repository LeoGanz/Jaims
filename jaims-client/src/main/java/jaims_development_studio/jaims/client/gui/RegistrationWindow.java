...
public class RegistrationWindow extends JWindow {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8237137125864257677L;
	...
	public RegistrationWindow(JFrame caller, ServerConnection con) {
		super(caller);
		setSize(300, 380);
	...
	private void initGUI(ServerConnection con) {
