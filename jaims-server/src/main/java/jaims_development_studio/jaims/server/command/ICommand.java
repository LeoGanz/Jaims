...
public interface ICommand extends Comparable<ICommand> {
	 ...
	 */
	void execute(Server server, ICommandSender sender, String[] args) throws Exception; //TODO specify exception
	 ...
	 */
	boolean checkPermission(Server server, ICommandSender sender);

	/**
	 * Get a list of all possible tab completions for this command.
	 */
	List<String> getTabCompletions(Server server, ICommandSender sender, String[] args);
