...
public class Settings extends UpdateTrackingUuidEntity {
	...
	public Settings(Date lastUpdated, Account account, UUID uuid, int arcMessages, int arcContactImage, int arcProfileImage,
			String ownFontName, int ownFontStyle, int ownFontSize, int colorOwnMessages, int colorOwnMessageBorder,
			int colorOwnMessageFont, String contactFontName, int contactFontStyle, int contactFontSize, int colorContactMessages,
			int colorContactMessageBorder, int colorContactMessageFont, String inputMixerInfoName, String outputMixerInfoName,
			float inputGain, float outputVolume, EInputEncodingType inputEncoding, float inputSampleRate, int inputSampleSize,
			int inputChannels, EEndianness endianness, int frameSize, EFileFormatType inputFormatType) {
	...
	public AccountUuidEntity copyWithoutAccount() {
		return new Settings(getLastUpdated(), null, getUuid(), arcMessages, arcContactImage, arcProfileImage, ownFontName, ownFontStyle,
				ownFontSize, colorOwnMessages, colorOwnMessageBorder, colorOwnMessageFont, contactFontName, contactFontStyle, contactFontSize,
				colorContactMessages, colorContactMessageBorder, colorContactMessageFont, inputMixerInfoName, outputMixerInfoName, inputGain,
				outputVolume, inputEncoding, inputSampleRate, inputSampleSize, inputChannels, endianness, frameSize, inputFormatType);
	}
